package com.han.gulimall.product.utils;
...
public class RedisUtil {
    ...
    public boolean isMember(String key, Object object){
        SetOperations<String, Object> set = redisTemplate.opsForSet();
        Boolean member = set.isMember(key, object);
        return member;
    }
    ...
    public Object popSet(String key){
        SetOperations<String, Object> set = redisTemplate.opsForSet();
        Object pop = set.pop(key);
        return pop;
    }
    public Long removeSetKeyValue(String key,String value){
